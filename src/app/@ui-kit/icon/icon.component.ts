...
export class IconComponent implements OnInit {
  ...
  getIconClass() {
    if (this.lib() == 'material') {
      return appIconLib[this.name()]?.material ? appIconLib[this.name()]?.material : 'info';
    }
    if (this.lib() == 'primeng') {
      return appIconLib[this.name()]?.primeng ? appIconLib[this.name()]?.primeng : 'pi pi-question-circle';
    }
    if (this.lib() == 'bootstrap') {
      return appIconLib[this.name()]?.bootstrap ? appIconLib[this.name()]?.bootstrap : 'bi bi-question-circle';
    }
  }
