...
export class SiteMetaComponent {
  ...
  // getFormData() {
  //   this.apiSvc.get(MyAppConfig.apiUrl.getMetaType).subscribe((val: any) => {
  ...
  getSiteMeta() {
    ...
    this.apiSvc.get(MyAppConfig.apiUrl.getSiteMeta, { headers: headers, params: params }).subscribe((response: any) => {
