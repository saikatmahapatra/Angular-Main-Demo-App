...
export class AnalyticsComponent implements OnInit {
  ...
  getProjectStatData() {
    ...
    let projectDetailsAPI = this.apiSvc.get(MyAppConfig.apiUrl.getProject, options);
    let analyticsDataAPI = this.apiSvc.post(MyAppConfig.apiUrl.timesheetChartData, this.myForm.value);
  ...
  getEmpChartData() {
    ...
    let userDataAPI = this.apiSvc.get(MyAppConfig.apiUrl.userData, options);
    let userAnalyticsAPI = this.apiSvc.post(MyAppConfig.apiUrl.userAnalytics, this.myForm.value);
